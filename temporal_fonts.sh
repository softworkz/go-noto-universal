...
echo "Generating GoNotoEmby-Regular.ttf. Current time: $(date)."
go_build GoNotoEmby.ttf "${GoNotoKurrentRegular[@]}"
mv GoNotoEmby.ttf GoNotoEmby-Regular.ttf

echo "Generating GoNotoEmby-Bold.ttf. Current time: $(date)."
go_build GoNotoEmby.ttf "${GoNotoKurrentBold[@]}"
mv GoNotoEmby.ttf GoNotoEmby-Bold.ttf
